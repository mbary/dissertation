...
class ScoreCam():
    ...
    def apply_colormap_on_image(self, filename, activation ,colormap_name="gnuplot2"):

        print("original image type", type(filename))

        org_im = Image.open(filename)
...
#             print("target class", target_class)
        ...
        no_trans_heatmap, heatmap_on_image = self.apply_colormap_on_image(filename, cam)
